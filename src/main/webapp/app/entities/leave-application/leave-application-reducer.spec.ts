...
import reducer, {
  ...
  reset,
  updateEntity,
} from './leave-application.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEAPPLICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEAVEAPPLICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEAVEAPPLICATION actions', async () => {
      const arg = { id: 21250 };
    ...
    it('dispatches UPDATE_LEAVEAPPLICATION actions', async () => {
      const arg = { id: 21250 };
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEAPPLICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEAVEAPPLICATION actions', async () => {
      const arg = 42666;
